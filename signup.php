...
<body>
    <form class="container mt-5 bg-white p-5 rounded-4 shadow-lg" id="signUpform" style="max-width: 500px;">
  <h2>Sign Up</h2>
  
  <div data-mdb-input-init class="form-outline mb-4">
    <label class="form-label text-dark fw-bold" for="form2Example1" >Email address</label>
    <input type="text" id="form2Example1" class="form-control border-primary signupemail" placeholder="Enter your email" />
</div>

<div data-mdb-input-init class="form-outline mb-4">
    <label class="form-label text-dark fw-bold" for="Pw">Password</label>
    <input type="password" id="Pw" class="form-control border-primary pw1" placeholder="Create a password" />
  </div>
<div data-mdb-input-init class="form-outline mb-4">
